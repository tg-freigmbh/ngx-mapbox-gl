...
import { BackgroundLayerSpecification, CanvasSource, CircleLayerSpecification, EasingOptions, FillExtrusionLayerSpecification, FillLayerSpecification, GeoJSONSourceSpecification, GeolocateControl, ImageSourceSpecification, LineLayerSpecification, Map, MapEventOf, MapMouseEvent, MapTouchEvent, RasterDEMSourceSpecification, RasterLayerSpecification, RasterSourceSpecification, SymbolLayerSpecification, VectorSourceSpecification, VideoSourceSpecification } from 'mapbox-gl';
...
export type LayerSpecificationProperty<K extends 'paint' | 'layout'> = BackgroundLayerSpecification[K] | FillLayerSpecification[K] | FillExtrusionLayerSpecification[K] | LineLayerSpecification[K] | SymbolLayerSpecification[K] | RasterLayerSpecification[K] | CircleLayerSpecification[K];
